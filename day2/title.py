...
title= soup.select_one('#PM_ID_ct > div.header > div.section_navbar > div.area_hotkeyword.PM_CL_realtimeKeyword_base > div.ah_list.PM_CL_realtimeKeyword_list_base') #무엇을 찾을건지.우클릭>검사>구문에 우클릭 copy>copy selector  후 복사
#title2=title.select('.ah_k')
...
#ul:nth-child(5) > li:nth-child(1) > a.ah_a > span.ah_k